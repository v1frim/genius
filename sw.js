...
const VERSION = 'genius-cache-v11';
const ASSETS = [
  '.', 'index.html', 'manifest.webmanifest', 'css/style.css',
  'js/store.js', 'js/oxford.js', 'js/sync.js', 'js/ui.js', 'js/data.js', 'js/data.prose.js', 'js/data.twisters.js', 'js/data.passages.js',
  ...
  'js/modules/memory.js', 'js/modules/meditation.js', 'js/modules/charisma.js', 'js/modules/chess.js', 'js/modules/goals.js',
  'js/modules/notes.js', 'js/modules/settings.js', 'js/app.js',
